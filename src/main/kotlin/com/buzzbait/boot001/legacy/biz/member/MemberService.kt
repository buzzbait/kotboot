...
import com.buzzbait.boot001.legacy.biz.member.dto.InlineMemberDto
import com.buzzbait.boot001.legacy.biz.member.dto.MemberGradeDto
...
import com.buzzbait.boot001.legacy.biz.member.repository.MemberRepository
...
class MemberService (
    ...
    * */
    ...
    @Transactional(readOnly = false)
    fun updateMember(
        updateMemberRequest: com.buzzbait.boot001.legacy.biz.member.dto.UpdateMemberRequest
    ):BuzzResponse{
